  ...
  return (
    ...
    >
      <div className="projects__navbar">
        ...
        <div
          className={active === "html_css" && "projects__navbar-active"}
          onClick={() => handleFilterCategory("html_css")}
        >
          HTML/CSS
        </div>
        <div
        ...
        <div className={active === "sass" && "projects__navbar-active"} onClick={() => handleFilterCategory("sass")}>
          SASS
        </div>
        <div
